...
public class ProjectCompositeIntegration {
    ...
    @Autowired
    Util util;
    private org.springframework.cloud.cloudfoundry.com.fasterxml.jackson.databind.ObjectReader productReader = null;
    ...
    private org.springframework.cloud.cloudfoundry.com.fasterxml.jackson.databind.ObjectReader getProjectReader() {
